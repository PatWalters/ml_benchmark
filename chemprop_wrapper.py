...
class ChemPropWrapper:
    ...
    def validate(self, train, test):
        pred = run_chemprop(train, test, self.y_name, num_epochs=50, accerlerator="gpu")
        return pred
...
class ChemPropRDKitWrapper:
    ...
    def validate(self, train, test):
        pred = run_chemprop_rdkit(train, test, self.y_name, num_epochs=50, accerlerator="gpu")
        return pred
...
def run_chemprop(train, test, y_col, num_epochs=20, accerlerator="cpu"):
